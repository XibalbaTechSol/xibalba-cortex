...
function CortexBrand({compact}: {compact?: boolean} = {}){return <div className="cortex-brand"><img src={compact ? "/cortex-icon-dark.png" : "/cortex-wordmark-dark.png"} alt="Xibalba Cortex"/></div>}
